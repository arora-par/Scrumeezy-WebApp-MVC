			...
			<div class="col-md-6 col-md-offset-3">
				<div class="well">
					<form:form action="register.htm" method="post" commandName="user">
						...
						<div class="form-group">
							<label class="login-dialog" for="firstName">First Name</label> <form:input
								type="text" class="form-control" path="firstName"
								placeholder="User Name" required="required"/>

						</div>
						
						<div class="form-group">
							<label class="login-dialog" for="lastName">Last Name</label> <form:input
								type="text" class="form-control" path="lastName"
								placeholder="User Name" required="required"/>

						</div>
						<div class="form-group">
							<label class="login-dialog" for="emailId">emailId</label> <form:input
								type="text" class="form-control" path="emailId"
								required="required"/>
						</div>
